export const CategoryItem = ({ name = "", icon = "", stores = 0, onClick }) => {
   return (
      <div id={name.replace(" ", "_")} className="relative py-2">
         <div class="rounded-lg border bg-indigo-100 p-4 md:p-5 my-2 text-md lg:text-xl font-semibold text-gray-700 flex items-center justify-between" onClick={onClick}>
